...
<head>
    ...
    <title>Construcciones EMCO S.A. de C.V.®</title>
    <link rel="icon" type="image/x-icon" href="assets/img/logos/LOGO_EMCO.png" />
...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#cobertura">Cobertura</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#capacitacion">Capacitaciones</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#clients">Clientes</a></li>
            ...
            <div class="col-md-7 containerNos text-center mt-n3">
                <div class="text-center">
                    ...
                    <div class="text-left my-5">
                        <div class="row">
                            <div class="card mx-0 justify-content-center">
                                <span class="fa-stack fa-3x" data-tilt>
                                    <i class="fas fa-circle fa-stack-2x text-primary"></i>
                                    <i class="fas fa-bullseye fa-stack-1x fa-inverse"></i>
                                </span>
                            </div>
                            <div class="card mx-0 justify-content-center">
                                <h2 class="secton-heading font-italic">
                                    <b class="py-2">Misión</b>
                                </h2>
                            </div>
                        </div>
                        <hr />
    ...
    <section class="page-section bg-light" id="cobertura">
        ...
        <div class="row mt-5">
            <div class="col-md-4 text-center aux1-padding">
                <div class="text-center">
                    <h3 class="text-muted my-5 text-justify">
                        Constructora ubicada en Toluca con alcance nacional
                    </h3>
                </div>
                <div class="map__list text-muted my-5 text-left px-3">
                    <ul>
                        <li><a class="js-scroll-trigger" href="#cobertura">Estado de México</a></li>
                        <li><a class="js-scroll-trigger" href="#cobertura">Querétaro</a></li>
                        <li><a class="js-scroll-trigger" href="#cobertura">Jalisco</a></li>
                        <li><a class="js-scroll-trigger" href="#cobertura">Veracruz</a></li>
                        <li><a class="js-scroll-trigger" href="#cobertura">Sinaloa</a></li>
                        <li><a class="js-scroll-trigger" href="#cobertura">San Luis Potosí</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="carousel-inner py-3">
                        <div class="carousel-item active">
                            <div class="row text-center justify-content-center">
                                <div class="card col-md-4 my-3 bg-dark">
                                    <span class="card-img-top fa-stack fa-5x" data-tilt>
                                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                                        <i class="fas fa-industry fa-stack-1x fa-inverse"></i>
                                    </span>
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">
                                            Mantenimiento Industrial</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Estructura Metálica</p>
                                            <p>Cimentaciones</p>
                                            <p>Bases de Tanques y Silos</p>
                                            <p>Redes de Drenaje</p>
                                            <p>Pisos de Concreto</p>
                                            <p>Montaje de Espectaculares</p>
                                            <p>Terracerías</p>
                                            <p>Demoliciones</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card col-md-4 my-3 bg-dark">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">Proyectos Arquitectónicos y Avalúos</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Dictámenes de Protección Civil</p>
                                            <p>Proyecto Ejecutivo</p>
                                            <p>Diseño y Cálculo Estructural</p>
                                            <p>Firma de Perito DRO</p>
                                            <p>Avalúos Inmobiliarios</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card col-md-4 my-3 bg-dark">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">Mantenimiento de Edificios</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Ampliación de Naves Industriales</p>
                                            <p>Remodelación a:</p>
                                            <div class="text-almost-white my-0">
                        ...
                        <div class="carousel-item">
                            <div class="row text-center justify-content-center">
                                <div class="card col-md-4 my-3 bg-dark">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">Pisos Epóxicos</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Recubrimiento y Abrillantado</p>
                                            <p>Señalizaciones</p>
                                            <p>Regeneración de Juntas</p>
                                            <p>Pisos de Poliuretano</p>
                                            <p>Franjas de Seguridad</p>
                                            <p>Autonivelación</p>
                                            <p>Pisos Antiderrapante</p>
                                            <p>Bacheo</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card col-md-4 my-3 bg-dark">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">Instalaciones</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Hidráulica y Sanitaria</p>
                                            <p>Electricidad</p>
                                            <p>Red Ambiental</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card col-md-4 my-3 bg-dark">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-white">Acabados</h5>
                                        <div class="card-text text-almost-white my-0">
                                            <p>Pisos de Ingeniería Industrial</p>
                                            <p>Multypanel</p>
                                            <p>Herrería</p>
                                            <p>Pintura, Yeso y Pastas</p>
                                            <p>Tablaroca</p>
                                            <p>Pisos Cerámicos</p>
                                            <p>Cancelería</p>
                                        </div>
        ...
        <div class="container">
            <div class="text-center mt-n4">
                ...
                <h6 class="section-subheading text-almost-white">
                    ...
                    normas Mexicanas; así como el desarrollo de manuales corporativos basados en nuestra <br />
                    experiencia y el servicio que ofrecemos</h6>
            </div>
            <!--Carrusel de items e imagen-->
            <div class="container row">
                ...
                <div class="card col-md-4 my-3 bg-dark">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="card-text text-almost-white my-0">
                            <p>Prevención y Combate de Incendios</p>
                            <p>Evacuación, Búsqueda y Rescate</p>
                ...
                <div class="card col-md-4 my-3 bg-dark">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title text-white">
                            Capacitación Especializada</h5>
                        <div class="card-text text-almost-white my-0">
                            <p>Incendios, Manejo de Extintores</p>
                            <p>Trabajo en Alturas</p>
                            <p>Espacios Confinados</p>
                            <p>Bloqueo y Candadeo</p>
                            <p>Corte y Soldadura</p>
                ...
                <div class="card col-md-4 my-3 bg-dark">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title text-white">Otras Capacitaciones</h5>
                        <div class="card-text text-almost-white my-0">
                            <p class="text-almost-white my-0">Ampliación de Naves Industriales</p>
                            <p class="text-almost-white my-0">Remodelación a:</p>
                            <div class="text-almost-white my-0">
                                <p>Manejo, Transporte de Sustancias Peligrosas</p>
                                <p>NOM - 018 - STPS - 2015</p>
    ...
    <section class="page-section bg-light" id="clients">
        <div class="container mt-n4">
            <div class="text-center">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_grupo_bimbo.png" alt="Bimbo" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_tia_rosa.png" alt="TiaRosa" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-4" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_yakult.png" alt="Yakult" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_hazpan.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_barcel.png" alt="" width="80" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-2" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_suandy.png" alt="" width="90" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_rotoplas.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_sugar_foods.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_ricolino.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_sigma.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_hitachi.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_humbrall.png" alt="" width="100" />
                    </div>
                    <div class="col-md-3 col-sm-6 my-3" data-tilt>
                        <img class="img-fluid d-block mx-auto" src="assets/img/logos/logo_collins.png" alt="" width="100" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Portfolio Modals-->
    <!-- Modal 1 - Bases para Silos-->
    <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark2">
                <div id="carouselModal1" class="carousel slide" data-ride="carousel">
                    <!-- Controles -->
                    <a class="carousel-control-prev" href="#carouselModal1" role="button" data-slide="prev">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-left fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
                    <a class="carousel-control-next" href="#carouselModal1" role="button" data-slide="next">
                        <span class="fa-stack fa-5x">
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark2">
                <div id="carouselModal2" class="carousel slide" data-ride="carousel">
                    <!-- Controles -->
                    <a class="carousel-control-prev" href="#carouselModal2" role="button" data-slide="prev">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-left fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
                    <a class="carousel-control-next" href="#carouselModal2" role="button" data-slide="next">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-right fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark2">
                <div id="carouselModal3" class="carousel slide" data-ride="carousel">
                    <!-- Controles -->
                    <a class="carousel-control-prev" href="#carouselModal3" role="button" data-slide="prev">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-left fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
                    <a class="carousel-control-next" href="#carouselModal3" role="button" data-slide="next">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-right fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal4" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark2">
                <div id="carouselModal4" class="carousel slide" data-ride="carousel">
                    <!-- Controles -->
                    <a class="carousel-control-prev" href="#carouselModal4" role="button" data-slide="prev">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-left fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
                    <a class="carousel-control-next" href="#carouselModal4" role="button" data-slide="next">
                        <span class="fa-stack fa-5x">
                            <i class="fas fa-chevron-right fa-stack-1x fa-inverse"></i>
                        </span>
                    </a>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/PisoEpoxico/Epoxico1.jpg" />
                        </div>
                        <div class="carousel-item">
